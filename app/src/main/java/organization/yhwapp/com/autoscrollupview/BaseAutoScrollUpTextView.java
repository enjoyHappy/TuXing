    ...
    private class AutoScrollAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView,
            ...
            if (null == convertView) {
                ...
                convertView = LayoutInflater.from(mContext).inflate(R.layout.auto_scroll_up_tv, null);
                viewHolder.mInfoView = (TextView) convertView.findViewById(R.id.auto_up_tv);
                convertView.setTag(viewHolder);
            } else {
                viewHolder = (ViewHolder) convertView.getTag();
            }
            T data = mDataList.get(position % mMax);
            viewHolder.mInfoView.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT,dip2px(getAdertisementHeight())));
